...
const renderEvents = (eventArray) => {
  ...
  eventArray.forEach((item) => {
    document.querySelector('#display-area').innerHTML += `<div class="card m-4" id="visitor-card--${item.eventID_firebaseKey}" style="border-radius: 10px; background-color: #484f58; color: white;">
